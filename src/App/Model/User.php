...
class User extends AbstractModel
{
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Model\Post", mappedBy="user")
     */
    private $posts;
     ...
     *
     * @API\Field(args={@API\Argument(name="status", type="?App\Types\PostStatusType")})
     *
     * @param string $status the status of posts as defined in \App\Model\Post
     *
     * @return Collection
     */
    ...
    /**
     * @API\Field(type="App\Model\Post[]", args={@API\Argument(name="ids", type="id[]")})
     *
     * @param array $ids
     */
